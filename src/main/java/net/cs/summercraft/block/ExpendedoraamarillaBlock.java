...
public class ExpendedoraamarillaBlock extends Block {
	...
	public ExpendedoraamarillaBlock() {
		super(PROPERTIES);
	}
	...
	public static void clientInit() {
		BlockRenderLayerMap.INSTANCE.putBlock(SummercraftModBlocks.EXPENDEDORAAMARILLA, RenderType.solid());
	}
}
